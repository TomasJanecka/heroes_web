...
export const TopNavbar: FC<Props> = ({activeHero, changeHero}) => {
    ...
    return (
        <StyledTopNavbar>
            ...
            <HeroButtons>
                <StyledButton $heroColor={THeroColor['crystal']} $justify={'center'}
                              onClick={() => changeHero('crystal')}>Crystal</StyledButton>
                <StyledButton $heroColor={THeroColor['toxic']} $justify={'center'}
                              onClick={() => changeHero('toxic')}>Toxic</StyledButton>
            </HeroButtons>
        </StyledTopNavbar>
    );
}
